...
class BST(BinaryTree):
    ...
    def __repr__(self):
        ...
        subclasses of BST will have a correct
    ...
    def _is_bst_satisfied(node):
        ...
        it only checks if the children of the
        current node are less than/greater than,
        rather than ensuring that all nodes to
        the left/right are less than/greater than.
    ...
    def insert(self, value):
        ...
        following the pattern of _is_bst_satisfied.
        '''
        if self.root:
    ...
    def insert_list(self, xs):
        ...
        correctly until you have gotten insert
        to work correctly.
        '''
        for x in xs:
            if self.root:
    ...
    def _find_smallest(node):
        ...
        and not intended to be called directly by
        the user.
        '''
